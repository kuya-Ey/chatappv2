...
test('kodego@test.com should be a credential', ()=>{
    credential = 'kodego@test.com';
    expect(credential).toContain('kodego@test.com');
});

test('12345678 should be a credential', ()=>{
    credential = '12345678';
    expect(credential).toContain('12345678');
});
